...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 10; // block 10
        consensus.BIP34Height = 20; // block 20
        consensus.BIP34Hash = uint256S("0x001"); // block 20
        consensus.BIP65Height = 30; // block 30
        consensus.BIP66Height = 30; // block 30
