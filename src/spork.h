...
static const int64_t SPORK_FXTC_03_BLOCK_REWARD_SMOOTH_HALVING_START_DEFAULT  = 1539964282;// OFF
// FXTC END
// VELES BEGIN
static const int64_t SPORK_VELES_01_FXTC_CHAIN_START_DEFAULT                 = 1539967928;// OFF
